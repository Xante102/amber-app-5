...
export class StudentsService {
  ...
  viewStudent(id: string): Observable<Student | any> {
    return this.http
      .get<Student>(`${this.REST_API}/${id}`, this.HTTP_HEADER)
      .pipe(
        tap((viewedStudent) =>
  ...
  addStudent(student: Student): Observable<Student> {
    return this.http
      .post<Student>(`${this.REST_API}/create`, student, this.HTTP_HEADER)
      .pipe(
        tap((addedStudent) =>
  ...
  deleteStudent(id: string): Observable<Student> {
    return this.http
      .delete<Student>(`${this.REST_API}/${id}`, this.HTTP_HEADER)
      .pipe(
        tap((deletedStudent) =>
